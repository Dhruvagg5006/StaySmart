...
export default function SignupPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Registration successful! Please enter the OTP code sent to your email.');
      setStep('verify');
    } catch (err: any) {
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: '#9898A0' }}>
            {step === 'signup'
              ? 'Get personalized AI property recommendations tailored to you'
          ...
          {step === 'signup' ? (
            <>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div>
                  <label className="text-xs font-semibold mb-1.5 block" style={{ color: '#9898A0' }}>USERNAME</label>
                  <div className="relative">
                    <UserIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: '#9898A0' }} />
                    <input
                      type="text"
            ...
            <form onSubmit={handleVerifyOTP} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="input-beacon w-full pl-10 pr-4 py-3 rounded-xl text-sm animate-pulse"
